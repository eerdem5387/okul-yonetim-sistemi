  ...
  useEffect(() => {
    ...
    const extractIdFromPath = async () => {
      try {
        ...
        console.log("[Edit Service] Contract ID from URL:", id, "Pathname:", pathname)
        
        // Her zaman ID'yi güncelle - pathname değiştiğinde veya mount olduğunda
        if (id && isMounted) {
          console.log("[Edit Service] Setting contract ID:", id)
    ...
    <div className="p-6">
      <div className="mb-6">
        <div className="flex items-center gap-4 mb-4">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Servis Sözleşmesi Düzenle</h1>
        </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>SERVİS SÖZLEŞMESİ</CardTitle>
          <CardDescription>

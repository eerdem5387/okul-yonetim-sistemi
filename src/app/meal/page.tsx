  ...
  return (
    <div className="p-3 sm:p-4 md:p-6">
      <div className="mb-4 sm:mb-6">
        <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900">Yemek Sözleşmesi</h1>
        <p className="text-gray-600 mt-1 sm:mt-2 text-xs sm:text-sm">Öğrenci yemek sözleşmesini oluşturun</p>
      </div>

      <div className="max-w-4xl mx-auto">
        <Card>
          <CardHeader className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 lg:py-6">
            <CardTitle className="text-base sm:text-lg lg:text-xl">Yemek Sözleşmesi</CardTitle>

/**
 * LEVENT COLLEGE GASTRONOMY ACTIVITY SCHEDULE
 * Gastronomy education participation certificate
 */
...
export interface GastronomiEgitimParticipant {
  firstName: string
  lastName: string
  tcNumber: string
  grade: string
...
export interface GastronomiEgitimCertData {
  title: string
  startDate: string
  endDate: string
  teacherName: string
  ...
  createdAt: string
  participants: GastronomiEgitimParticipant[]
}
...
function participantPage(data: GastronomiEgitimCertData, participant: GastronomiEgitimParticipant): string {
  ...
  <div class="cert-page">
    ...
    <div class="cert-header">
      ...
      <div class="cert-school-info">
        ...
        <div class="cert-school-subtitle">IB Programme · Gastronomy Education</div>
      </div>
    </div>
    ...
    <div class="cert-programme-title">
      ...
      <div class="cert-programme-line cert-programme-accent">GASTRONOMY ACTIVITY SCHEDULE</div>
    </div>
...
export function buildGastronomiEgitimCertificateHTML(data: GastronomiEgitimCertData): string {
...
<head>
  ...
  <title>Gastronomy Activity Schedule — Certificate</title>
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .cert-divider-top {
      height: 3px;
      background: linear-gradient(90deg, #9f1239 0%, #fb7185 40%, #e11d48 60%, #9f1239 100%);
      margin: 10px 0;
      border-radius: 2px;
      position: relative;
      z-index: 1;
    ...
    .cert-divider-bottom {
      height: 2px;
      background: linear-gradient(90deg, #9f1239 0%, #fb7185 50%, #9f1239 100%);
      margin: 14px 0 10px;
      border-radius: 2px;
      position: relative;
      z-index: 1;
    ...
    .cert-sign-line { height: 1px; background: #881337; margin-bottom: 6px; }
    .cert-sign-name { font-size: 12px; font-weight: 600; color: #881337; }

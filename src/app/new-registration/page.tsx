...
export default function NewRegistrationPage() {
  ...
  const handleDownloadCombinedPDF = async () => {
    ...
    const contractDataWithFees = applyFixedContractFees(mainContractData)
    const identityErrors = validateStudentIdentityFields(studentFormData)
    const contractErrors = validateContractFields(contractDataWithFees, {
    ...
    try {
      ...
      const pdfResponse = await fetch(`/api/pdf/combined/${contractId}`, {
        ...
        body: JSON.stringify({
          ...
          mainContractData: contractDataWithFees,
